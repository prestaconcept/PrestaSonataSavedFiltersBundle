...
final class FilterSetAdminUnprotectTest extends AdminTestCase
{
    public function testUnprotect(): void
    {
        ...
        // When
        self::$client->request('PUT', "/presta/sonata-filters-set/filters-set/{$filter->getId()}/unprotect");
    ...
    public function testUnprotectNotFound(): void
    {
        ...
        // When
        self::$client->request('PUT', '/presta/sonata-filters-set/filters-set/1/unprotect');
